...
public class ArenaManager extends Manager
{
    ...
    public void loadArenas() {
        ...
        for (final String arenaName : arenaSection.getKeys(false)) {
            final String serializedFirstTeamLocation = arenaSection.getString(String.valueOf(arenaName) + ".firstTeamLocation");
            final String serializedSecondTeamLocation = arenaSection.getString(String.valueOf(arenaName) + ".secondTeamLocation");
            final boolean enabled = arenaSection.getBoolean(String.valueOf(arenaName) + ".enabled");
    ...
    public void saveArenas() {
        ...
        for (final Map.Entry<String, Arena> arenaEntry : this.arenaMap.entrySet()) {
            ...
            if (arena.getFirstTeamLocation() != null) {
                ...
                fileConfig.set("arenas." + arenaName + ".firstTeamLocation", null);
                fileConfig.set("arenas." + arenaName + ".secondTeamLocation", null);
                fileConfig.set("arenas." + arenaName + ".enabled", null);
                fileConfig.set("arenas." + arenaName + ".firstTeamLocation", serializedFirstTeamLocation);
                fileConfig.set("arenas." + arenaName + ".secondTeamLocation", serializedSecondTeamLocation);
                fileConfig.set("arenas." + arenaName + ".enabled", enabled);
                fileConfig.set("arenas." + arenaName + ".kits", kits);
            }
        }
